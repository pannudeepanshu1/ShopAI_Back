1. **Voice Input to Add and Delete Products (Using ChatBot MIRA)** :  enabling users to effortlessly manage their product lists. Customers can use voice commands to add or remove items from their shopping carts.
